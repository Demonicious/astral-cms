...
return [
     ...
     */
    'setting' => [
        'class' => \BladeBuilder\Setting::class
    ],
     ...
     */
    'page' => [
        'class' => \BladeBuilder\Page::class,
        'table' => 'pages',
        'translation' => [
            'class' => \BladeBuilder\PageTranslation::class,
     ...
     */
    'renderers' => [
        'dynamic-block' => \BladeBuilder\Modules\GrapesJS\Block\DynamicBlockRenderer::class,
        'layout'        => \BladeBuilder\Modules\GrapesJS\Layout\LayoutRenderer::class
    ],
    ...
    'cache' => [
        ...
        'class' => \BladeBuilder\Cache::class
    ],
     ...
     */
    'theme' => [
        'class' => \BladeBuilder\Theme::class,
     ...
     */
    'router' => [
        'class' => \BladeBuilder\Modules\Router\DatabasePageRouter::class,
        'use_router' => true
    ],
