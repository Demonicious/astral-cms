...
use BladeBuilder\Contracts\AuthContract;
use BladeBuilder\Contracts\PageContract;
use BladeBuilder\Contracts\PageTranslationContract;
use BladeBuilder\Contracts\WebsiteManagerContract;
use BladeBuilder\Contracts\PageBuilderContract;
use BladeBuilder\Contracts\RouterContract;
use BladeBuilder\Contracts\ThemeContract;
use BladeBuilder\Modules\GrapesJS\PageRenderer;
use BladeBuilder\Repositories\UploadRepository;
use BladeBuilder\Core\DB;
...
class BladeBuilder
{
    ...
    /**
     * Set the BladeBuilder configuration to the given array.
     *
     * @param array $config
     */
    ...
    /**
     * Set the BladeBuilder database connection using the given array.
     *
     * @param array $config
     */
    ...
    /**
     * Return the Auth instance of this BladeBuilder.
     *
     * @return AuthContract
     */
    ...
    /**
     * Return the WebsiteManager instance of this BladeBuilder.
     *
    ...
    /**
     * Return the PageBuilder instance of this BladeBuilder.
     *
    ...
    /**
     * Return the Router instance of this BladeBuilder.
     *
    ...
    /**
     * Return the Theme instance of this BladeBuilder.
     *
    ...
    public function handleRequest($action = null)
    {
        ...
        if (! phpb_config('auth.use_login') || ! phpb_config('website_manager.use_website_manager')) {
            die('The BladeBuilder Authentication module is disabled, but no alternative has been implemented (you are still calling the standard handleRequest() method).<br>'
        ...
        if (phpb_in_module('website_manager')) {
            ...
            die('BladeBuilder WebsiteManager page not found');
        }
        ...
        if (phpb_in_module('pagebuilder')) {
            ...
            die('BladeBuilder PageBuilder page not found');
        }
        ...
        die('BladeBuilder page not found. Check your URL: <b>' . phpb_e(phpb_full_url(phpb_current_relative_url())) . '</b>');
    }
    ...
    public function handlePublicRequest()
    {
        ...
        // if we are on the URL of a BladeBuilder asset, return the asset
    ...
    public function handleUploadedFileRequest()
    {
        ...
        // add backwards compatibility for files uploaded with BladeBuilder <= v0.12.0, stored as /uploads/{id}.{extension}
