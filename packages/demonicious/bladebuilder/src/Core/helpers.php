...
if (! function_exists('phpb_asset')) {
    /**
     * Return the public path of a BladeBuilder asset.
     *
     * @param string $path
     * @return string
     */
...
if (! function_exists('phpb_autoload')) {
    /**
     * Autoload classes from the BladeBuilder package.
     *
    ...
    function phpb_autoload($className)
    {
        ...
        // remove leading BladeBuilder/ from the class path
        $fileName = str_replace('BladeBuilder' . DIRECTORY_SEPARATOR, '', $fileName);
